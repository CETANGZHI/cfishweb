...
const UserDashboardPage = () => {
  ...
  const getActivityIcon = (type) => {
    switch (type) {
      ...
      case 'bid': return <Award className="h-4 w-4" />;
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="h-16 w-16 bg-primary/20 rounded-full flex items-center justify-center text-primary text-xl font-bold">
